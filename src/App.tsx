...
type View = 'inspector' | 'batch' | 'diff' | 'lineage' | 'evidence' | 'settings';
...
function FutureView({ view, result }: { view: Exclude<View, 'inspector' | 'batch' | 'diff'>; result: VerificationResult | null }) {
  const titles: Record<Exclude<View, 'inspector' | 'batch' | 'diff'>, string> = {
    lineage: 'Manifest Lineage',
    evidence: 'Evidence Export',
    settings: 'Trust Anchors / Settings'
  };
  const descriptions: Record<Exclude<View, 'inspector' | 'batch' | 'diff'>, string> = {
