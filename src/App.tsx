...
function FutureView({ view, result }: { view: Exclude<View, 'inspector' | 'batch' | 'diff' | 'simulator' | 'playground'>; result: VerificationResult | null }) {
  const titles: Record<Exclude<View, 'inspector' | 'batch' | 'diff' | 'simulator' | 'playground'>, string> = {
    lineage: 'Manifest Lineage',
    evidence: 'Evidence Export',
    settings: 'Trust Anchors / Settings'
  };
  const descriptions: Record<Exclude<View, 'inspector' | 'batch' | 'diff' | 'simulator' | 'playground'>, string> = {
